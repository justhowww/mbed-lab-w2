...
public:
    ...
    void run()
    {
        ...
        while (1){
            ...
            // printf("{\"x\":%f,\"y\":%f,\"z\":%f,\"s\":%d}",(float)((int)(x*10000))/10000,(float)((int)(y*10000))/10000, (float)((int)(z*10000))/10000, sample_num);
            int len = sprintf(acc_json,"{\"x\":%f,\"y\":%f,\"z\":%f,\"s\":%d}",(float)((int)(x*10000))/10000,(float)((int)(y*10000))/10000, (float)((int)(z*10000))/10000, sample_num);
